...
const ViewProduct = () => {
    ...
    const selectedProduct = hardcodedProducts.find(product => String(product._id) === productID);
                ...
                <>
                    {
                        responseDetails ?
                            ...
                            <>
                             {  selectedProduct  ? (
                                 <ProductContainer>
                                    <ProductImage src={selectedProduct.productImage} alt={selectedProduct.productName} />
                                        <ProductInfo>
                                            <ProductName>{selectedProduct.productName}</ProductName>
                                            <PriceContainer>
                                                <b>Price:</b> <PriceCost>₹{selectedProduct.price.cost}</PriceCost>                                                
                                                <b>MRP:</b>: <PriceMrp>₹{selectedProduct.price.mrp}</PriceMrp>
                                                <PriceDiscount>{selectedProduct.price.discountPercent}% off</PriceDiscount>
                                            </PriceContainer>
